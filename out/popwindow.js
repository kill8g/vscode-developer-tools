...
class SelectionPanel {
    ...
    title;
    options;
    static viewType = 'selectionPanel';
    panel;
    resolveCallback;
    rejectCallback;
    constructor(context, title, options) {
    ...
    show() {
        return new Promise((resolve, reject) => {
            ...
            this.panel = vscode.window.createWebviewPanel(SelectionPanel.viewType, this.title, vscode.ViewColumn.One, {
                enableScripts: true,
